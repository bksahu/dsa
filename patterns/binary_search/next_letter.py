...
Idea: 
-> Take care of the out of bound cases then take care of inside.
-> This is just like finding ceil but with diffence in case where letters[mid] == key
"""
...
if __name__ == "__main__":
    print(next_letter(['a', 'c', 'f', 'h'], key = 'f'))
    print(next_letter(['a', 'c', 'f', 'h'], key = 'b'))
    print(next_letter(['a', 'c', 'f', 'h'], key = 'm'))
    print(next_letter(['a', 'c', 'f', 'h'], key = 'h'))
    print(next_letter(["c", "f", "j"], key='a'))